...
export const ProjectDrawer: FC<ProjectDrawerProps> = (props) => {
  const { container, onClose, open, project, onUpdateProject } = props;
  ...
  const handleSaveEdit = useCallback(async (id: string, values: {}) => {
    try {
      await firebaseUpdateProjects.updateProject(id, values, onUpdateProject);
